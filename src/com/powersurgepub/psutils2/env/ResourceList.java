...
public class ResourceList {
  ...
  public ResourceList (ComboBox comboBox) {
  ...
  */
  public boolean load (ComboBox comboBox) {
    this.comboBox = comboBox;
    this.list = null;
    return load();
  }
  ...
  */
  public void add (String anotherItem) {
    if (comboBox != null) {
      comboBox.getItems().add(anotherItem);
    } else {
  ...
  */
  public void add (int i, String anotherItem) {
    if (comboBox != null) {
      comboBox.getItems().add(i, anotherItem);
    } else {
  ...
  */
  public String get (int i) {
    if (comboBox != null) {
      return comboBox.getItems().get(i).toString();
    } else {
