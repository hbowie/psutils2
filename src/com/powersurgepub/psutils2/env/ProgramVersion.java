...
public class ProgramVersion 
  ...
  public void informUserIfNewer () {
    ...
    if (newerVersionAvailable) {
      ...
      alert.setHeaderText("A newer version is available");
      alert.setContentText("Would you like to check it out?");
  ...
  public void informUserIfLatest () {
    if (! newerVersionAvailable) {
      ...
      alert.setTitle("All is cool");
      alert.setHeaderText("Program Version is up-to-date");
      alert.setContentText("You're already running the latest version");
      alert.showAndWait();
    }
  }
