  ...
  public void add(Taggable tagged) {
    ...
    while (iterator.hasNextTag() || nodesStored < 1) {
      ...
      */
      ...
      // levels1 = the number of levels1 in the new tagged item's tags
      int levels = tags.getLevels (tagIndex);
      // System.out.println ("      levels1 = " + String.valueOf(levels1));
      boolean done = false;
        ...
        switch (compass) {
          case (BELOW_THIS_NODE):
            ...
            if (currentNode.getChildren().size() > 0) {
              ...
              newNode.getValue().setTreeLevel(level);
  ...
  public int compareNodes (
    ...
    /* if (node2 == null) {
      ...
      System.out.println ("Comparing " 
          ...
          + "-" + this.toString()
          +"(" + String.valueOf(levels1)
          + ") to " + String.valueOf (node2.getNodeType())
          + "-" + node2.toString()
          + "(" + String.valueOf (node2.getLevel()) + ")");
    }
    */
      ...
      switch (type2) {
        ...
        case (TagsNodeValue.TAG):
          ...
          if (treeLevel1 == treeLevel2) { 
            ...
            // We are currently on a category node with a number of levels1
            // less than or equal to the number of levels1 of the item
